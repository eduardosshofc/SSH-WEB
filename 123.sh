...
wget https://raw.githubusercontent.com/eduardosshofc/SSH-WEB/main/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://raw.githubusercontent.com/eduardosshofc/SSH-WEB/main/verifatt.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/eduardosshofc/SSH-WEB/main/verpweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/eduardosshofc/SSH-WEB/main/verweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/eduardosshofc/SSH-WEB/main/whatsapp.sh > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/eduardosshofc/SSH-WEB/main/gestorssh.zip > /dev/null 2>&1
...
echo ""
chave=$(curl -sSL "https://raw.githubusercontent.com/eduardosshofc/SSH-WEB/main/chave") &>/dev/null

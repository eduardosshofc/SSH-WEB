...
```
apt install wget -y; bash <(wget -qO- https://raw.githubusercontent.com/eduardosshofc/SSH-WEB/ubuinst.sh)
```
</br>
...
```
apt install wget -y; bash <(wget -qO- https://raw.githubusercontent.com/eduardosshofc/SSH-WEB/sincpainel.sh)
```
